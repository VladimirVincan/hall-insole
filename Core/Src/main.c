...
int main(void)
{
  ...
  c3dhall11_init(huart2, hi2c1, C3DHALL11_DEVICE_ADDRESS);
  HAL_StatusTypeDef read_status = HAL_OK;
  while (1)
  {
//	   // ---------------- HALL 9 ----------------
//	   read_status = c3dhall9_read_data(huart2, hi2c1, C3DHALL9_I2C_DEFAULT_ADDR);
...
//	   }
//
//	   read_status = c3dhall9_read_data(huart2, hi2c1, C3DHALL9_I2C_NEW_ADDR);
//	   if (read_status == HAL_OK) {
//		   sprintf(buf, "NEW\nx : %.1f\ny : %.1f\nz : %.1f\ntemp : %.1f\n", c3dhall9_get_x(), c3dhall9_get_y(), c3dhall9_get_z(), c3dhall9_get_temp());
//		   HAL_UART_Transmit(&huart2, buf, strlen((char*)buf), HAL_MAX_DELAY);
//		   HAL_Delay(100);
...
//	   c3dhall9_write_register(hi2c1, C3DHALL9_I2C_NEW_ADDR, C3DHALL9_REG_EEPROM_02,
